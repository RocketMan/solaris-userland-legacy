...
APACHE_MODULE_SO       ?= .libs/$(APACHE_MODULE_NAME).so
...
COMPONENT_BUILD_ACTION = \
	...
	$(APXS) -c -o $(APACHE_MODULE_SO) $(APACHE_MODULE_SRC) && rm -f $(APACHE_MODULE_SO) ; \
	$(ENV) $(COMPONENT_BUILD_ENV) \
	$(CC) $(CFLAGS) -shared -o $(APACHE_MODULE_SO) $(APACHE_MODULE_OBJ) $(APACHE_MODULE_LDFLAGS)
